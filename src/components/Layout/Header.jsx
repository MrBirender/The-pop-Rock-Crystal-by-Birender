...
export default function Header() {
  return (
    <header className="flex pt-8 md:px-16 px-4 justify-between items-center ">
          ...
          >
            ...
            <defs>
              <clipPath id="clip0_1_54">
                <rect width="37" height="64" fill="white"></rect>
              </clipPath>
            </defs>
          </svg>
        </div>
      ...
      <div className="flex md:gap-44 gap-10 font-semibold ">
        <ul className="text-white flex items-center gap-10 text-xl">
          <li>Home</li>
          <li>Shop</li>
          <li>About</li>
          <li>Help</li>
